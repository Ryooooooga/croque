...
pub struct GhPullRequestConfig {
    #[serde(default)]
    pub icons: PullRequestIcons,
    ...
    #[serde(default = "GhPullRequestConfig::default_content")]
    pub content: String,
}
...
impl Default for GhPullRequestConfig {
    fn default() -> Self {
        Self {
...
#[derive(Debug, Deserialize)]
pub struct PullRequestIcons {
    #[serde(default = "PullRequestIcons::default_open")]
    pub open: String,

    #[serde(default = "PullRequestIcons::default_draft")]
    pub draft: String,

    #[serde(default = "PullRequestIcons::default_closed")]
    pub closed: String,
...
impl Default for PullRequestIcons {
    fn default() -> Self {
        Self {
